...
public class ExcluirBeneficiarioValidatorTests
{
    private readonly IValidator<ExcluirBeneficiarioCommand> _validator = new ExcluirBeneficiarioValidator();
    ...
    {
        // Arrange
        var command = new ExcluirBeneficiarioCommand()
        {
            IdCotacao = 0
        };

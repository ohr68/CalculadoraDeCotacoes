...
public class DetalharCotacaoValidatorTests
{
    private readonly IValidator<DetalharCotacaoQuery> _validator = new DetalharCotacaoValidator();
    ...
    {
        // Arrange
        var query = new DetalharCotacaoQuery()
        {
            IdCotacao = 0
        };

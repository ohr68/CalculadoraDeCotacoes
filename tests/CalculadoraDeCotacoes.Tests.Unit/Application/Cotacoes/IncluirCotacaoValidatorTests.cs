...
public class IncluirCotacaoValidatorTests
{
    private readonly IValidator<IncluirCotacaoCommand> _validator = new IncluirCotacaoValidator();
    ...
    [Fact(DisplayName = "Ao não informar uma cobertura do tipo Básica deve retornar um erro")]
    public void Should_Have_Error_When_Doesnt_Have_Cobertura_Basica()
    {
        // Arrange
        var command = new IncluirCotacaoCommand()
        {
            ...
            {
                new() { IdCobertura = 1, TipoCobertura = TipoCobertura.Adicional }
            }
        };
        ...
        // Assert
        result.ShouldHaveValidationErrorFor(i => i.Coberturas)
            .WithErrorMessage("É obrigatório informar apenas uma cobertura do tipo 'Básica'.");
    }

    [Fact(DisplayName = "Ao informar duas coberturas do tipo Básica deve retornar um erro")]
    public void Should_Have_Error_When_Have_More_Than_One_Cobertura_Basica()
    {
        // Arrange
        var command = new IncluirCotacaoCommand()
        {
            ...
            Coberturas = new List<CoberturaInputModel>()
            {
                ...
                new() { IdCobertura = 2, TipoCobertura = TipoCobertura.Basica }
            }
        };
    ...
    [Fact(DisplayName = "Ao não informar ao menos uma cobertura do tipo Adicional deve retornar um erro")]
    public void Should_Have_Error_When_Doesnt_Have_Cobertura_Adicional()
    {
        // Arrange
        var command = new IncluirCotacaoCommand()
        {
        ...
        // Assert
        result.ShouldHaveValidationErrorFor(i => i.Coberturas)
            .WithErrorMessage("É obrigatório informar ao menos uma cobertura do tipo 'Adicional'.");
    }
    ...
    {   // Arrange
        ...
        result.ShouldNotHaveValidationErrorFor(x => x.Beneficiarios);
        result.ShouldNotHaveValidationErrorFor(x => x.Coberturas);
